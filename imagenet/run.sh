...
for i in {0..9}
do
    #CUDA_VISIBLE_DEVICES=8 python -u imagenetc.py --cfg cfgs/10orders/tent/tent$i.yaml
    CUDA_VISIBLE_DEVICES=1 python -u imagenetc.py --cfg cfgs/10orders/cotta/cotta$i.yaml
done
